...
#ifdef CBEZC3D_PRIVATE_HEADER
#   define CBEZC3D_TYPEDEFS
#endif

#ifdef CBEZC3D_TYPEDEFS

/* Data structures; never to be accessed from application programs */

typedef struct ECBezC3DWCRec {
  WCRec                            points[4];
  union {
    AttributesRec            any;
    struct {
...
#endif /* CBEZC3D_TYPEDEFS */

/* methods for a cubic Bezier curve 3d; */
...
static EGMethodsRec cbezc3d_graphic_methods = {
/*    TYPE_FUNC_P           */   Type,
...
#undef CBEZC3D_PRIVATE_HEADER

#else

extern EGMethodsRec cbezc3d_graphic_methods;

#endif /* CBEZC3D_PRIVATE_HEADER */
