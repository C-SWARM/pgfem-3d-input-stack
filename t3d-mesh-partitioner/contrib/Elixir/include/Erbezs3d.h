...
#ifdef RBEZS3D_PRIVATE_HEADER
#   define RBEZS3D_TYPEDEFS
#endif

#ifdef RBEZS3D_TYPEDEFS

/* Data structures; never to be accessed from application programs */

typedef struct ERBezS3DWCRec {
	int                                 order_u;
	int                                 order_v;
  WCRec                               *points;
	float                               *weights;
...
static EGMethodsRec rbezs3d_graphic_methods = {
/*    TYPE_FUNC_P           */   Type,
...
#undef RBEZS3D_PRIVATE_HEADER

#endif /* RBEZS3D_PRIVATE_HEADER */
