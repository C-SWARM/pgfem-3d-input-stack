...
#ifdef LINE3D_PRIVATE_HEADER
#   define LINE3D_TYPEDEFS
#endif


#ifdef LINE3D_TYPEDEFS

/* Data structures; never to be accessed from application programs */

typedef struct ELine3DWCRec {
  WCRec                            start_point;
  WCRec                            end_point;
  union {
    AttributesRec            any;
...
#endif /* LINE3D_TYPEDEFS */
 
/* Methods for a line3d; they are NEVER CALLED DIRECTLY -- always */
...
static void 
RetrieveFrom(FILE *file_p, GraphicSpecObj *);
static void 
...
static EGMethodsRec line3d_graphic_methods = {
/*    TYPE_FUNC_P           */   Type,
...
#undef LINE3D_PRIVATE_HEADER

#endif /* LINE3D_PRIVATE_HEADER */
