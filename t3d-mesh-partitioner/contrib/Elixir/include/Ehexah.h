...
#ifdef HEXAH_PRIVATE_HEADER
#   define HEXAH_TYPEDEFS
#endif

#ifdef HEXAH_TYPEDEFS

/* Data structures; never to be accessed from application programs */

typedef struct EHexahedronWCRec {
    /* 
     points[0] ... u=-1, v=-1, w=-1
     points[1] ... u=-1, v= 1, w=-1
     points[2] ... u= 1, v= 1, w=-1
     points[3] ... u= 1, v=-1, w=-1
     points[4] ... u=-1, v=-1, w= 1
     points[5] ... u=-1, v= 1, w= 1
     points[6] ... u= 1, v= 1, w= 1
     points[7] ... u= 1, v=-1, w= 1
     */
  WCRec                              points[8];
  union {
    AttributesRec            any;
...
#endif /* HEXAH_TYPEDEFS */

/* methods for a hexahedron; they are NEVER CALLED DIRECTLY -- always */
...
static EGMethodsRec hexah_graphic_methods = {
/*    TYPE_FUNC_P           */   Type,
...
#undef HEXAH_PRIVATE_HEADER

#endif /* HEXAH_PRIVATE_HEADER */
