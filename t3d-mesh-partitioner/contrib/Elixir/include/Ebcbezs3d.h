...
#ifdef BCBEZS3D_PRIVATE_HEADER
#   define BCBEZS3D_TYPEDEFS
#endif

#ifdef BCBEZS3D_TYPEDEFS

/* Data structures; never to be accessed from application programs */

typedef struct EBCBezS3DWCRec {
  WCRec                               points[4][4];
  union {
    AttributesRec            any;
    struct {
...
#endif /* BCBEZS3D_TYPEDEFS */

/* methods for a bicubic Bezier surface patch;  */
...
static GraphicObj *
Reshape(GraphicObj *p, EHandleNum hn, WCRec *);
static EHandleNum   
...
static EGMethodsRec bcbezs3d_graphic_methods = {
/*    TYPE_FUNC_P           */   Type,
...
#undef BCBEZS3D_PRIVATE_HEADER

#endif /* BCBEZS3D_PRIVATE_HEADER */
...
GraphicObj *
CurvesToBCBezS3D(GraphicObj *curves[], int how_many);
GraphicObj *
