...
#ifdef BCBHEX_PRIVATE_HEADER
#   define BCBHEX_TYPEDEFS
#endif

#ifdef BCBHEX_TYPEDEFS

/* Data structures; never to be accessed from application programs */

typedef struct EBCBHexWCRec {
  WCRec                               points[56];
  union {
    AttributesRec            any;
    struct {
...
#endif /* BCBHEX_TYPEDEFS */


/* methods for a bicubic Bezier hexahedron;  */
...
static  EGMethodsRec bcbhex_graphic_methods = {
/*    TYPE_FUNC_P           */   Type,
...
#undef BCBHEX_PRIVATE_HEADER

#endif /* BCBHEX_PRIVATE_HEADER */
