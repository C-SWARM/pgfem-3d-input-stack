...
#ifdef PYRAMID_PRIVATE_HEADER
#   define PYRAMID_TYPEDEFS
#endif

#ifdef PYRAMID_TYPEDEFS

/* Data structures; never to be accessed from application programs */

typedef struct EPyramidWCRec {
  WCRec                              point_1;
  WCRec                              point_2;
  WCRec                              point_3;
  WCRec                              point_4;
...
#endif /* PYRAMID_TYPEDEFS */

/* methods for a Pyramid; they are NEVER CALLED DIRECTLY -- always */
...
static EGMethodsRec pyramid_graphic_methods = {
/*    TYPE_FUNC_P           */   Type,
...
#undef PYRAMID_PRIVATE_HEADER

#endif /* PYRAMID_PRIVATE_HEADER */
